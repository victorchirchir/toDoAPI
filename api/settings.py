...
SECRET_KEY = os.getenv('SECRET_KEY','hhhhhjklllkjh')
...
#Pagination did not work, will have to see why
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': [
        ...
        # 'rest_framework.renderers.BrowsableAPIRenderer',#removes the Rest framework interface leaving only json values
    ]
}
